...
//    func activate(_ card: SkillCard, for user: BattleComponent, on target: BattleComponent, completion: @escaping (StatusEffect, Bool) -> ()) {
...
//    }
//    
//    func persistentEffect(_ effect: StatusEffect, on target: BattleComponent) -> Bool {
//        let attackRoll = Int(arc4random_uniform(UInt32(100))) + 1
//        
//        if target.didResist(attackRoll) {
//            return false
//        } else {
//            target.persistingStatus.append(effect)
//            return true
//        }
//        
//    }
